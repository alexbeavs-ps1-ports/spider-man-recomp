...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "SPIDER_MAN_PROJECT_ROOT",
    .build_dir_env = "SPIDER_MAN_BUILD_DIR",
    .force_setup_env = "SPIDER_MAN_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_008.75_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Spider_Man_Recompiled",
    .prepare_note =
